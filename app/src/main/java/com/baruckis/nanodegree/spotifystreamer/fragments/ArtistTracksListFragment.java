...
public class ArtistTracksListFragment extends ListFragment {
    ...
    public interface Callbacks {
         ...
         */
        void onItemSelected(ArrayList<CustomTrack> tracksList, Integer index);
    }
    ...
    public void showSelectedArtistTopTracks(String artistId, String artistName) {
        ...
        mSpotifyService.getArtistTopTrack(artistId, mCountryCode, new Callback<Tracks>() {
            @Override
            ...
            public void failure(RetrofitError error) {
                ...
                Log.e(ArtistTracksListFragment.class.getSimpleName(), error.getMessage());
                showError();
            }
        });
    }
